...
class RecipeModel(models.Model):
    ...
    Ingredients = models.JSONField(RecipeIngredient, help_text='Recipe Ingredients')
    Author = models.OneToOneField(RecipeAuthor, help_text='Recipe Author', blank=True, on_delete=models.DO_NOTHING, null=True)
